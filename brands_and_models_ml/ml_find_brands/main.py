...
with open('C:\\Users\\Johny\\Desktop\\CarHut\\ml\\ml\\brands_and_models_ml\\labeling_headers\\resources\\X.txt', 'r', encoding='utf-8') as file:
    X = file.readlines()
with open('C:\\Users\\Johny\\Desktop\\CarHut\\ml\\ml\\brands_and_models_ml\\labeling_headers\\resources\\y.txt', 'r', encoding='utf-8') as file:
    y = file.readlines()
# Preprocess data
...
joblib.dump(model, 'brand_classification_model.pkl')
