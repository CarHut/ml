...
def add_labels(brand_and_model):
    ...
    with open('C:\\Users\\Johny\\Desktop\\CarHut\\ml\\brands_and_models_ml\\find_model\\resources\\bazos_assigned_headers.txt', 'a', encoding="utf-8") as the_file:
        the_file.write(f'{header_ids[current_header_count]};{headers[current_header_count]}\n')

    with open('C:\\Users\\Johny\\Desktop\\CarHut\\ml\\brands_and_models_ml\\find_model\\resources\\bazos_assigned_labels.txt', 'a', encoding="utf-8") as the_file:
...
def init():
    ...
    global header_ids
    try:
        with open('C:\\Users\\Johny\\Desktop\\CarHut\\ml\\brands_and_models_ml\\find_model\\resources\\bazos_assigned_headers.txt', 'r', encoding="utf-8") as f:
