...
brand_classification_model_path = "C:\\Users\\Johny\\Desktop\\CarHut\\ml\\brands_and_models_ml\\find_model\\model_classification_model_with_processed_data.pkl"
vectorizer_path = "C:\\Users\\Johny\\Desktop\\CarHut\\ml\\brands_and_models_ml\\find_model\\model_vectorizer_with_processed_data.pkl"
...
window.bind("<Escape>", key_stroke)

current_header_count = 0
first_header = True
headers = []
header_ids = []
header_label = tk.Label(window, text=f'{''}', font=('Arial', 25), bg='#1A1A1D', fg='#ffffff')
brand_and_model_box = tk.Text(window, height=5, width=40, bg='#1A1A1D', fg='#ffffff')
...
def update_header():
    ...
    header_label.configure(text=f'{headers[current_header_count]}')

def add_labels(brand_and_model):
    brand_and_model = brand_and_model.replace("\n", "").replace("\r", "")
    with open('C:\\Users\\Johny\\Desktop\\CarHut\\ml\\brands_and_models_ml\\find_model\\resources\\autobazar_eu_assigned_headers.txt', 'a', encoding="utf-8") as the_file:
        the_file.write(f'{header_ids[current_header_count]};{headers[current_header_count]}\n')

    with open('C:\\Users\\Johny\\Desktop\\CarHut\\ml\\brands_and_models_ml\\find_model\\resources\\autobazar_eu_assigned_labels.txt', 'a', encoding="utf-8") as the_file:
...
def init():
    ...
    global header_ids
    try:
        with open('C:\\Users\\Johny\\Desktop\\CarHut\\ml\\brands_and_models_ml\\find_model\\resources\\autobazar_eu_assigned_headers.txt', 'r', encoding="utf-8") as f:
...
#     global header_ids
#     try:
#         with open('C:\\Users\\Johny\\Desktop\\CarHut\\ml\\brands_and_models_ml\\find_model\\resources\\autobazar_eu_old_assigned_headers.txt', 'r', encoding="utf-8") as f:
#             last_line = f.readlines()[-1]
#         file_last_id = last_line.split(";")[0]
